...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"exerciseTableViewCell" forIndexPath:indexPath];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    NSMutableArray *muscleGroupNames = [[NSMutableArray alloc] init];
    for (MuscleGroup *mg in exercise.muscleGroups) {
        [muscleGroupNames addObject:mg.name];
    }
